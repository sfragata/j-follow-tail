...
public class JFollowTailFrame extends JFrame implements PropertyChangeListener {
	...
	private void createTopPanel() {
		...
		adminHighlightingButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				highlightingsDialog.addPropertyChangeListener(HighlightingsDialog.LIST_CHANGED_EVENT,
	...
	protected void openLogFile(File file) {
		try {
			...
			tabbedPane.addTab(logFilePanel.getFileName(), ResourcesFactory.getActiveLogIcon(), logFilePanel,
					logFilePanel.getPath());
			tabbedPane.setTabComponentAt(logFilePanels.size() - 1,
					new TabCustomTitle(logFilePanel.getFileName(), logFile, tabbedPane, JFollowTailFrame.this));
			...
			JOptionPane.showMessageDialog(JFollowTailFrame.this, errorMessage, "Error in log File",
	...
	@Override
	public void propertyChange(PropertyChangeEvent evt) {
		if (PropertyChange.SCROLL_CHANGED_BY_USER.name().equals(evt.getPropertyName())) {
